...
(function($) {
  $(document).ready(function() {
    ...
    var prefix = '#id_itemreceipt_set-';
    var pricePrefix = '#id_itemreceipt_set-{0}-price';
    var quantityPrefix = '#id_itemreceipt_set-{0}-quantity';
    var priceTotalPrefix = '#id_itemreceipt_set-{0}-priceTotal';
    ...
    function calculateTotalAmount() {
      var total = 0;
      $('input[name^="itemreceipt_set-"][name$="-priceTotal"]').each(function() {
...
var total = 0;
$('input[name^="itemreceipt_set-"][name$="-quantity"]').each(function() {
...
return total.toFixed(4);
    ...
    function handleFieldChanges() {
      $('input[name^="itemreceipt_set-"][name$="-price"], input[name^="itemreceipt_set-"][name$="-quantity"]').on('change', function() {
  ...
  (function($) {
    $(document).ready(function() {
        ...
        $('input[name^="itemreceipt_set-"][name$="-code"]').each(function() {
