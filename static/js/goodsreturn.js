...
(function($) {
    $(document).ready(function() {
      ...
      var prefix = '#id_goodsreturnitem_set-';
      var pricePrefix = '#id_goodsreturnitem_set-{0}-price';
      var quantityPrefix = '#id_goodsreturnitem_set-{0}-quantity';
      var priceTotalPrefix = '#id_goodsreturnitem_set-{0}-priceTotal';
      ...
      function calculateTotalAmount() {
        var total = 0;
        $('input[name^="goodsreturnitem_set-"][name$="-priceTotal"]').each(function() {
...
function calculateTotalQty() {
  var total = 0;
  $('input[name^="goodsreturnitem_set-"][name$="-quantity"]').each(function() {
  ...
  return total.toFixed(4);
      ...
      function handleFieldChanges() {
        $('input[name^="goodsreturnitem_set-"][name$="-price"], input[name^="goodsreturnitem_set-"][name$="-quantity"]').on('change', function() {
...
(function($) {
  $(document).ready(function() {
      ...
      $('input[name^="goodsreturnitem_set-"][name$="-code"]').each(function() {
