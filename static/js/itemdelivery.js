...
(function($) {
    $(document).ready(function() {
      ...
      var prefix = '#id_itemdelivery_set-';
      var pricePrefix = '#id_itemdelivery_set-{0}-price';
      var quantityPrefix = '#id_itemdelivery_set-{0}-quantity';
      var priceTotalPrefix = '#id_itemdelivery_set-{0}-priceTotal';
      ...
      function calculateTotalAmount() {
        var total = 0;
        $('input[name^="itemdelivery_set-"][name$="-priceTotal"]').each(function() {
  ...
  var total = 0;
  $('input[name^="itemdelivery_set-"][name$="-quantity"]').each(function() {
  ...
  return total.toFixed(4);
      ...
      function handleFieldChanges() {
        $('input[name^="itemdelivery_set-"][name$="-price"], input[name^="itemdelivery_set-"][name$="-quantity"]').on('change', function() {
    ...
    (function($) {
      $(document).ready(function() {
          ...
          $('input[name^="itemdelivery_set-"][name$="-code"]').each(function() {
