...
(function($) {
    $(document).ready(function() {
      ...
      var prefix = '#id_issueforproductionitem_set-';
      var pricePrefix = '#id_issueforproductionitem_set-{0}-price';
      var quantityPrefix = '#id_issueforproductionitem_set-{0}-quantity';
      var priceTotalPrefix = '#id_issueforproductionitem_set-{0}-priceTotal';
      ...
      function calculateTotalAmount() {
        var total = 0;
        $('input[name^="issueforproductionitem_set-"][name$="-priceTotal"]').each(function() {
...
function calculateTotalQty() {
  var total = 0;
  $('input[name^="issueforproductionitem_set-"][name$="-quantity"]').each(function() {
  ...
  return total.toFixed(4);
      ...
      function handleFieldChanges() {
        $('input[name^="issueforproductionitem_set-"][name$="-price"], input[name^="issueforproductionitem_set-"][name$="-quantity"]').on('change', function() {
