...
(function($) {
    $(document).ready(function() {
      ...
      var prefix = '#id_purchaseitem_set-';
      var pricePrefix = '#id_purchaseitem_set-{0}-price';
      var quantityPrefix = '#id_purchaseitem_set-{0}-quantity';
      var priceTotalPrefix = '#id_purchaseitem_set-{0}-priceTotal';
      ...
      function calculateTotalAmount() {
        var total = 0;
        $('input[name^="purchaseitem_set-"][name$="-priceTotal"]').each(function() {
...
function calculateTotalQty() {
  var total = 0;
  $('input[name^="purchaseitem_set-"][name$="-quantity"]').each(function() {
  ...
  return total.toFixed(4);
      ...
      function handleFieldChanges() {
        $('input[name^="purchaseitem_set-"][name$="-price"], input[name^="purchaseitem_set-"][name$="-quantity"]').on('change', function() {
...
(function($) {
  $(document).ready(function() {
      ...
      $('input[name^="purchaseitem_set-"][name$="-code"]').each(function() {
