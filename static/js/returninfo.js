...
(function($) {
    $(document).ready(function() {
      ...
      var prefix = '#id_returnitem_set-';
      var pricePrefix = '#id_returnitem_set-{0}-price';
      var quantityPrefix = '#id_returnitem_set-{0}-quantity';
      var priceTotalPrefix = '#id_returnitem_set-{0}-priceTotal';
      ...
      function calculateTotalAmount() {
        var total = 0;
        $('input[name^="returnitem_set-"][name$="-priceTotal"]').each(function() {
  ...
  var total = 0;
  $('input[name^="returnitem_set-"][name$="-quantity"]').each(function() {
  ...
  return total.toFixed(4);
      ...
      function handleFieldChanges() {
        $('input[name^="returnitem_set-"][name$="-price"], input[name^="returnitem_set-"][name$="-quantity"]').on('change', function() {
...
(function($) {
  $(document).ready(function() {
      ...
      $('input[name^="returnitem_set-"][name$="-code"]').each(function() {
